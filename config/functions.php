...
function render($content, $arr = array()){

	if(!isset($content)) $content = "View can't be found";
	  
	  Flight::render('_header.php', array(), 'header');
	  Flight::render('_footer.php', array(), 'footer');
	  Flight::render($content,  $arr, 'content');
	  Flight::render('_layout.php');
}
